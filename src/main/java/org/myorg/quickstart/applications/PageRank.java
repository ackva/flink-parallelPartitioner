...
import org.myorg.quickstart.jobstatistics.PageRankData;
 ...
 * on Flink cluster incl call: ../flink/flink/bin/flink run -p 2 -c org.myorg.quickstart.applications.PageRank ~/jobsFlink/flink-parallelPartitioner.jar --links jobsFlink/input/hamsterster.txt --pages jobsFlink/input/pages_hamsterster.txt --output jobsFlink/output/pageRank --iterations 5
 *
