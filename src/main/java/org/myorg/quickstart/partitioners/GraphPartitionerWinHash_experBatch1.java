...
import org.myorg.quickstart.partitioners.matchFunctions.MatchFunctionWinHash_experBatch1;
 ...
 *
 */
public class GraphPartitionerWinHash_experBatch1 {
    ...
    GraphPartitionerWinHash_experBatch1(
    ...
    public void partitionGraph() throws Exception {
        ...
        MatchFunctionWinHash_experBatch1 matchFunction = new MatchFunctionWinHash_experBatch1(algorithm, k, lambda);
