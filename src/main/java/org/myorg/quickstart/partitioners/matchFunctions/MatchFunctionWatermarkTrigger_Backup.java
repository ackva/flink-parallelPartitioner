 ...
 * DONT USE! ONLY FOR "logging reasons"
 *
...
public class MatchFunctionWatermarkTrigger_Backup extends KeyedBroadcastProcessFunction<Integer, Edge<Integer, Long>, Tuple2<HashMap<Integer, Integer>,Long>, Tuple2<Edge<Integer, Long>,Integer>> {
    ...
    List<Edge<Integer, Long>> waitingEdges;
...
/** The state that is maintained by this process function *//*
   ...
   //MapStateDescriptor<String, Tuple2<Long,Boolean>> updatedStateDescriptor = new MapStateDescriptor<>("keineAhnung", BasicTypeInfo.STRING_TYPE_INFO, ValueTypeInfo.BOOLEAN_VALUE_TYPE_INFO);
    ...
    public MatchFunctionWatermarkTrigger_Backup(String algorithm, Integer k, double lambda, int stateDelay) {
