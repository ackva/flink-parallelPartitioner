 ...
 * <ol>
 *     <li>the {@link #processBroadcastElement(Object, org.apache.flink.streaming.api.functions.co.KeyedBroadcastProcessFunction.Context, Collector)} which will be applied to
 *     each element in the broadcast side
 *     <li> and the {@link #processElement(Object, org.apache.flink.streaming.api.functions.co.KeyedBroadcastProcessFunction.ReadOnlyContext, Collector)} which will be applied to the
 ...
 */
@PublicEvolving
public abstract class KeyedBroadcastProcessFunctionCustom<KS, IN1, IN2, OUT> extends BaseBroadcastProcessFunction {
     ...
     * @param ctx A {@link org.apache.flink.streaming.api.functions.co.KeyedBroadcastProcessFunction.ReadOnlyContext} that allows querying the timestamp of the element,
     ...
     */
    public abstract void processElement(final IN1 value, final org.apache.flink.streaming.api.functions.co.KeyedBroadcastProcessFunction.ReadOnlyContext ctx, final Collector<OUT> out) throws Exception;
     ...
     * the local partition. These can be done through the provided {@link org.apache.flink.streaming.api.functions.co.KeyedBroadcastProcessFunction.Context}.
     * The context is only valid during the invocation of this method, do not store it.
     *
     * @param value The stream element.
     * @param ctx A {@link org.apache.flink.streaming.api.functions.co.KeyedBroadcastProcessFunction.Context} that allows querying the timestamp of the element,
     ...
     *                   to fail and go into recovery.
     */
    public abstract void processBroadcastElement(final IN2 value, final org.apache.flink.streaming.api.functions.co.KeyedBroadcastProcessFunction.Context ctx, final Collector<OUT> out) throws Exception;

    /**
     * Called when a timer set using {@link TimerService} fires.
     *
     * @param timestamp The timestamp of the firing timer.
     * @param ctx An {@link org.apache.flink.streaming.api.functions.co.KeyedBroadcastProcessFunction.OnTimerContext} that allows querying the timestamp of the firing timer,
     ...
     */
    public void onTimer(final long timestamp, final org.apache.flink.streaming.api.functions.co.KeyedBroadcastProcessFunction.OnTimerContext ctx, final Collector<OUT> out) throws Exception {
    ...
    /**
     * Information available in an invocation of {@link #onTimer(long, org.apache.flink.streaming.api.functions.co.KeyedBroadcastProcessFunction.OnTimerContext, Collector)}.
     */
