...
public class BroadcastPartitionerWindowed {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<EdgeSimple> edgeStream = graph.getEdges();
        graph.printGraph();
        ...
        KeyedStream<EdgeSimple, Integer> edgeKeyedStream = env.fromCollection(edgeStream.subList(0,5))
...
*/
        ...
        KeyedStream<EdgeSimple, Integer> edgeKeyedStream2 = env.fromCollection(edgeStream.subList(5,10))
                .rebalance()                               // needed to increase the parallelism
                .map(edgeSimple -> edgeSimple)
                .setParallelism(2)
                .keyBy(EdgeSimple::getOriginVertex);
...
/*        DataStream<Tuple2<Integer, List<Integer>>> streamOutput2 = DataStreamUtils
        ...
        KeyedStream<EdgeSimple, Integer> edgeKeyedStream3 = env.fromCollection(edgeStream.subList(10,15))
                .rebalance()                               // needed to increase the parallelism
                .map(edgeSimple -> edgeSimple)
                .setParallelism(2)
                .keyBy(EdgeSimple::getOriginVertex);
